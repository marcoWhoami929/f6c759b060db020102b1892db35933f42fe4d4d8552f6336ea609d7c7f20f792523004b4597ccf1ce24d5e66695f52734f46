...
class ModeloAdministradores
{
	...
	static public function mdlIngresarPerfil($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(name, email, password, profile, photo, state) VALUES (:nombre, :email, :password, :perfil, :foto, :estado)");
	...
	static public function mdlEditarPerfil($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET name = :nombre, email = :email, password = :password, profile = :perfil, photo = :foto WHERE id = :id");
