...
class ModeloSubCategorias
{
	...
	static public function mdlActualizarOfertaSubcategorias($tabla, $datos, $ofertadoPor)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET $ofertadoPor = :$ofertadoPor, offer = :oferta, offerPrice = :precioOferta, discountOffer = :descuentoOferta, imgOffer = :imgOferta, expiredOffer = :finOferta WHERE categoryId = :id_categoria");
	...
	static public function mdlIngresarSubCategoria($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(subcategory, categoryId, route, state, offer, offerPrice, discountOffer, imgOffer, expiredOffer) VALUES (:subcategoria, :id_categoria, :ruta, :estado, :oferta, :precioOferta, :descuentoOferta, :imgOferta, :finOferta)");
	...
	static public function mdlEditarSubCategoria($tabla, $datos)
	{
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET 	subcategory = :subcategoria, categoryId = :id_categoria, route = :ruta, state = :estado, offer = :oferta, offerPrice = :precioOferta, discountOffer = :descuentoOferta, imgOffer = :imgOferta, expiredOffer = :finOferta WHERE id = :id");
