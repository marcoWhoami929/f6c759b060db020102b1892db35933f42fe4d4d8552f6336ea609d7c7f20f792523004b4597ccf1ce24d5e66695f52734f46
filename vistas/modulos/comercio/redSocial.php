...
$redSocial = json_decode($plantilla["socialNetworks"], true);
...
<div class="box box-success">
	...
	<div class="box-body">
			...
			echo '<div class="form-group row">
					...
					<div class="col-xs-8">
						...
						<div class="input-group">
							...
							<span class="input-group-addon"><i class="' . $value["red"] . ' ' . $value["estilo"] . ' redSocial"></i></span>
		...
		<input type="hidden" id="valorRedesSociales" value="<?php echo $plantilla["socialNetworks"]; ?>">
