          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg tituloBanner" placeholder="Ingresar Titulo Banner" name="tituloBanner">
            ...
            <div class="form-group">
              ...
              <p class="help-block">Tamaño recomendado 1400px * 292px <br> Peso máximo de la foto 2MB</p>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg editarTituloBanner" placeholder="Ingresar Titulo Banner" name="editarTituloBanner">
