...
$(".tablaCategorias tbody").on("click", ".btnEditarCategoria", function () {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      datosCabecera.append("ruta", respuesta["route"]);
      ...
      $.ajax({
        ...
        success: function (respuesta) {
          ...
          $("#modalEditarCategoria .descripcionCategoria").val(
          ...
          if (respuesta["keywords"] != null) {
            $(".editarPalabrasClaves").html(
              '<div class="input-group">' +
                ...
                '<input type="text" class="form-control input-lg pClavesCategoria tagsInput" data-role="tagsinput" value="' +
                respuesta["keywords"] +
                '" name="pClavesCategoria" required>' +
                "</div>"
            );
          ...
          $("#modalEditarCategoria .previsualizarPortada").attr(
            "src",
            respuesta["frontPage"]
          );
          $("#modalEditarCategoria .antiguaFotoPortada").val(
            respuesta["frontPage"]
          );
        },
      });
      ...
      if (respuesta["offer"] != 0) {
        ...
        $("#modalEditarCategoria #descuentoOferta").val(
          respuesta["discountOffer"]
        );
        ...
        $("#modalEditarCategoria .previsualizarOferta").attr(
          "src",
          respuesta["imageOffer"]
        );

        $("#modalEditarCategoria .antiguaFotoOferta").val(
          respuesta["imageOffer"]
        );

        $("#modalEditarCategoria .finOferta").val(respuesta["expiredOffer"]);
      } else {
...
$(".tablaCategorias tbody").on("click", ".btnEliminarCategoria", function () {
  ...
  swal({
    ...
    if (result.value) {
      window.location =
        "index.php?ruta=categorias&idCategoria=" +
        idCategoria +
        "&imgOferta=" +
        imgOferta +
        "&rutaCabecera=" +
