...
class ControladorCategorias
{
		...
		if (isset($_POST["tituloCategoria"])) {
			...
			if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["tituloCategoria"]) && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descripcionCategoria"])) {
				...
				if ($_POST["selActivarOferta"] == "oferta") {
					...
					$datos = array(
						"categoria" => strtoupper($_POST["tituloCategoria"]),
				...
				$respuesta = ModeloCategorias::mdlIngresarCategoria("categories", $datos);
	...
	static public function ctrEditarCategoria()
	{
		...
		if (isset($_POST["editarTituloCategoria"])) {
			...
			if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarTituloCategoria"]) && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descripcionCategoria"])) {
				...
				ModeloSubCategorias::mdlActualizarOfertaSubcategorias("subcategories", $datos, "offerForCategory");

				$traerProductos = ModeloProductos::mdlMostrarProductos("products", "categoryId", $datos["id"]);
				...
				foreach ($traerProductos as $key => $value) {
					...
					ModeloProductos::mdlActualizarOfertaProductos("products", $datos, "offerForCategory", $precioOfertaActualizado, $descuentoOfertaActualizado, $value["id"]);
				}

				ModeloCabeceras::mdlEditarCabecera("headers", $datos);

				$respuesta = ModeloCategorias::mdlEditarCategoria("categories", $datos);
	...
	static public function ctrEliminarCategoria()
	{
		...
		if (isset($_GET["idCategoria"])) {
			...
			$traerSubCategorias = ModeloSubCategorias::mdlMostrarSubCategorias("subcategories",  "categoryId", $_GET["idCategoria"]);
			...
			if ($traerSubCategorias) {
				...
				foreach ($traerSubCategorias as $key => $value) {
					...
					ModeloSubCategorias::mdlActualizarSubCategorias("subcategories", $item1, $valor1, $item2, $valor2);
				}
			}
			...
			$traerProductos = ModeloProductos::mdlMostrarProductos("products", "categoryId", $_GET["idCategoria"]);
			...
			$respuesta = ModeloCategorias::mdlEliminarCategoria("categories", $_GET["idCategoria"]);
