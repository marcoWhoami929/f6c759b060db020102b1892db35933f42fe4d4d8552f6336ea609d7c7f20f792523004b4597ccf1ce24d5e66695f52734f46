...
class AjaxProductos
{
	...
	/*=============================================
  	ACTIVAR PRODUCTOS MAS VENDIDO
 	=============================================*/

	public $activarProductoVendido;

	public function ajaxActivarProductoVendido()
	{

		$tabla = "products";

		$item1 = "selled";
		$valor1 = $this->activarProductoVendido;
	...
	public $rutaProducto;
	public $rutaProductoMercadoLibre;
...
if (isset($_POST["activarProductoVendido"])) {

	$activarProductoVendido = new AjaxProductos();
	$activarProductoVendido->activarProductoVendido = $_POST["activarProductoVendido"];
	$activarProductoVendido->activarId = $_POST["activarId"];
	$activarProductoVendido->ajaxActivarProductoVendido();
}
...
if (isset($_POST["tituloProducto"])) {
	...
	$producto->rutaProductoMercadoLibre = $_POST["rutaProductoMercadoLibre"];
...
if (isset($_POST["id"])) {
	...
	$editarProducto->rutaProductoMercadoLibre = $_POST["rutaProductoMercadoLibre"];
