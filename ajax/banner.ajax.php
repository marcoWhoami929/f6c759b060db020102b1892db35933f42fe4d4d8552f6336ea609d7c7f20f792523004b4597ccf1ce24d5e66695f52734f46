...
class AjaxBanner
{
  ...
  public function ajaxActivarBanner()
  {
    ...
    $respuesta = ModeloBanner::mdlActualizarBanner("banner", "state", $this->activarBanner, "id", $this->activarId);
  ...
  public function ajaxTraerRutasBanner()
  {
    ...
    if ($tabla == "colormatch") {
      ...
      $respuesta = ModeloBanner::mdlMostrarColorMatch($tabla, $item, $valor);
