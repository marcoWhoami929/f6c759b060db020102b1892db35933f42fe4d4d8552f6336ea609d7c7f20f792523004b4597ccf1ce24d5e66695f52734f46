...
class AjaxCategorias
{
  ...
  public function ajaxActivarCategoria()
  {
    ...
    ModeloSubCategorias::mdlActualizarSubCategorias("subcategories", "state", $this->activarCategoria, "categoryId", $this->activarId);

    ModeloProductos::mdlActualizarProductos("products", "state", $this->activarCategoria, "categoryId", $this->activarId);

    $respuesta = ModeloCategorias::mdlActualizarCategoria("categories", "state", $this->activarCategoria, "id", $this->activarId);
